...
def contact(request):
    if request.method == 'POST':
        ...
        # Check if the user had made inquiry already
        ...
        send_mail(
            ...
            'There has been an inquiry for ' +listing+ '. sign into the admin panel fore more info',
            'from@example.com',
            [realtor_email, 'messieo.104@gmail.com'],
            fail_silently=False,
        )
